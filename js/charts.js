...
//Objects containing Monthly traffic chart data.
...
//Objects containing Daily traffic chart data.
...
//Objects containing Hourly traffic chart data.
...
//Objects containing Weekly traffic chart data.
...
const mobileData = {
	...
	datasets: [{
		...
		data: [2000, 550, 500],
		borderWidth: 0,
		backgroundColor: ['purple', 'rgb(233, 186, 233)', 'rgb(151, 78, 151)', ]
	}]
};
const mobileOptions = {
	legend: {
